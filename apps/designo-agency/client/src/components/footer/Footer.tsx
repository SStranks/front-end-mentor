...
function Footer(): JSX.Element {
  ...
  return (
    <footer className={`${styles['footer']} ${pathname === '/contact' ? styles['routeContactPage'] : ''}`}>
      <div className={styles['footer__container']}>
        {pathname !== '/contact' && (
          <div className={styles['footer__hero']}>
            <div>
              <p className={styles['footer__hero__header']}>Let&#39;s talk about your project</p>
        ...
        <div className={styles['footer__nav']}>
          <Link to="/">
            <img className={styles['footer__logo']} src={LogoLight} alt="Designo Site Home." />
          </Link>
