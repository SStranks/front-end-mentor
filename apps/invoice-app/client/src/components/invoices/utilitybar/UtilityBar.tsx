  ...
  return (
    <div className={styles['container']}>
      <div className={styles['container__titleblock']}>
        <h1>Invoices</h1>
        {numberInvoicesTotal !== undefined && <p>There are {numberInvoicesTotal} total invoices</p>}
      </div>
      <div className={styles['container__controls']}>
        <DropdownFilterStatus filterStatus={filterStatus} setFilterStatus={setFilterStatus} />
        <BtnNewInvoice onClick={btnNewInvoiceClickHandler} value={undefined} disabled={undefined} />
      </div>
