...
boardRouter.route('/:boardId').get(getBoard).post(createColumn).patch(updateBoard).delete(deleteBoard);

boardRouter.route('/:boardId/:columnId').post(createTask).patch(updateColumn).delete(deleteColumn);

boardRouter.route('/:boardId/:columnId/:taskId').patch(updateTask).delete(deleteTask);
