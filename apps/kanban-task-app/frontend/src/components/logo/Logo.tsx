...
function Logo(): JSX.Element {
  ...
  // TODO:  Convert click over into 'loading' state passed into component.
  const click = () => {
    const rectangles = container.current?.querySelectorAll('[data-logo-rectangle]');
    rectangles?.forEach((rect, i) => {
      rect.classList.toggle(`${styles[`logoRect_${i % 2}`]}`);
    });
  ...
  return (
    ...
    <div className={styles.container} onClick={click} ref={container}>
        ...
        <svg width="153" height="26" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(0 1)" fill="#635FC7">
              <rect data-logo-rectangle width="6" height="25" rx="2" />
              <rect data-logo-rectangle opacity=".75" x="9" width="6" height="25" rx="2" />
              <rect data-logo-rectangle opacity=".5" x="18" width="6" height="25" rx="2" />
            </g>
          </g>
        </svg>
      </div>
      ...
      <div className={styles['logo--logoMobile']}>
