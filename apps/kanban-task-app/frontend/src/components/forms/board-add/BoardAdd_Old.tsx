...
import { genGroupInputs, updateInput, updateInputFromGroup, validateInputs } from '#Utils/formFunctions';
import { useContext, useState } from 'react';
import DynamicInputList from '#Components/custom/dynamic-list/DynamicInputList';
import styles from './_BoardAdd_Old.module.scss';
...
function BoardAdd(props: TProps): JSX.Element {
  ...
  const submitHandler = async (e: React.FormEvent) => {
    ...
    const { 'input-title': name, ...rest } = Object.fromEntries(formInputData.entries()) as Record<string, string>;
