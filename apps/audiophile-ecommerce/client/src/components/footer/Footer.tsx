...
function Footer(): JSX.Element {
  return (
    <footer className={styles['footer']} id="skipto-footer" data-testid="skipto-footer">
      ...
      <div className={styles['footer__bottombar']}>
        ...
        <div className={styles['footer__social']}>
          <a href="http://www.facebook.com" target="_blank" rel="noopener noreferrer">
            <img className={styles['footer__social__icon']} src={IconFacebook} alt="Facebook Media Page" />
          </a>
          <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer">
            <img className={styles['footer__social__icon']} src={IconTwitter} alt="Twitter Media Page" />
          </a>
          <a href="http://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <img className={styles['footer__social__icon']} src={IconInstagram} alt="Instagram Media Page" />
          </a>
        </div>
      </div>
    </footer>
