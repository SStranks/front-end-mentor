...
function CompanyStatement(props: ElemProps): JSX.Element {
  ...
  return (
    <article className={`${styles['card']} ${appendClass}`} aria-labelledby="company statement">
      ...
      <picture className={styles['card__picture']}>
        <source srcSet="/img/shared/desktop/image-best-gear.jpg" media="(min-width: 1024px)" width="540" height="588" />
        <source srcSet="/img/shared/tablet/image-best-gear.jpg" media="(min-width: 576px)" width="1378" height="600" />
        <source srcSet="/img/shared/mobile/image-best-gear.jpg" media="(max-width: 575px)" width="654" height="600" />
        <img
