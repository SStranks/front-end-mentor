...
function Home(): JSX.Element {
  return (
    <div className={styles['container']}>
      <header className={styles['hero']} id="skipto-main" data-testid="skipto-main">
        <picture>
          <source srcSet="/img/home/desktop/image-hero.jpg" media="(min-width: 992px)" width="1440px" height="729px" />
          <source
            ...
            height="1458px"
          />
          <source srcSet="/img/home/mobile/image-header.jpg" media="(max-width: 575px)" width="750px" height="1200px" />
          <img src="/img/home/desktop/image-hero.jpg" className={styles['hero__img']} alt="XX99 mark 2 headphones" />
        </picture>
