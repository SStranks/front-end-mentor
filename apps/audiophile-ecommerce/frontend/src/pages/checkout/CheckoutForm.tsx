...
function CheckoutForm(props: ElemProps): JSX.Element {
  ...
  const grandTotal = formatCurrency(totalAmount + Number(vatAmount) + shippingAmount);
  ...
  return (
    <form className={styles['form']} onSubmit={onSubmit} noValidate aria-label="form">
      ...
      <div className={styles['summary']} data-testid="checkout summary">
        ...
        <div className={styles['summary__financial']} data-testid="summary financial">
          <p className={styles['summary__financial__heading']}>total</p>
          <p className={styles['summary__financial__total']}>$ {totalAmountDisplayValue}</p>
          <p className={styles['summary__financial__heading']}>shipping</p>
          <p className={styles['summary__financial__total']}>$ {shippingAmount}</p>
          <p className={styles['summary__financial__heading']}>vat &#40;included&#41;</p>
          <p className={styles['summary__financial__total']}>$ {vatDisplayValue}</p>
          <p className={`${styles['summary__financial__heading']} ${styles['gridLastRow']}`}>grand total</p>
          <p className={styles['summary__financial__grandTotal']}>$ {grandTotal}</p>
        </div>
