  ...
  return list.length > 0 ? (
    ...
    <div className={styles.noList}>
      ...
      <div className={styles.btn}>
        <Button text="+ Add Feedback" disabled={false} classList={['bg-magenta']} onClick={() => setModalOpen(true)} />
      </div>
      <Modal handleClose={() => setModalOpen(false)} modalOpen={modalOpen}>
        <FormFeedbackNew cancelBtnOnClick={() => setModalOpen(false)} modalOpen={modalOpen} />
      </Modal>
    </div>
  );
}
